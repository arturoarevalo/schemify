...
describe "integer schema", () ->
    ...
    describe "without default value", () ->
        ...
        describe "creates as expected", () ->
            ...
            check = (param) ->
                schema.integer.createNew param
    ...
    describe "with a default value", () ->
        ...
        describe "validates as expected", () ->
            ...
            defaultValue = 9999
            check = (param) ->
                schema.integer.default(defaultValue).check param
        ...
        describe "creates as expected", () ->
            ...
            defaultValue = 9999
            check = (param) ->
                schema.integer.default(defaultValue).createNew param
